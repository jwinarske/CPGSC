...
/*
OBJECT NAME:  struct soctl_ octlB
       TYPE:  struct soctl_
      LEVEL:  0
 DEFINED IN:  SIODEF.H
DECLARED IN:  IBMPC.C
...
*/
struct vregbits_ stopsB =          /* for 16x50 UART */
       {
...
struct vregbits_ dlenB =           /* for 16x50 UART */
     {
...
SIO COM2sio  =
     ...
     v_regB,                       /*13 Pointer to virtual register array    */
     V_REG_SIZE,                   /*14 Number of rows in virtual array      */
     &parityB,                     /*15 Parity structure                     */
     &stopsB,                      /*16 Stop bit structure                   */
     &dlenB,                       /*17 Data length structure                */
     &baudB,                       /*18 Baud rate structure                  */
     &pin4B,                       /*19 RS-232 RTS output                    */
     &pin20B,                      /*20 RS-232 DTR output                    */
     &gp1outB,                     /*21 RS-232 first user-defined output     */
     &gp2outB,                     /*22 RS-232 first user-defined output     */
     &breakbB,                     /*23 Break bit                            */
     &pin5B,                       /*24 RS-232 CTS input                     */
     &pin6B,                       /*25 RS-232 DSR input                     */
     &pin8B,                       /*26 RS-232 DCD input                     */
     &pin22B,                      /*27 RS-232 RI  input                     */
     ...
     &octlB,                       /*47 Pointer to output control structure  */
     &ictlB,                       /*48 Pointer input control structure      */
