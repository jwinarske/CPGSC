...
struct modem baselineC =
     {
     0,                          /*0  Interuint8_t delay                     */
...
struct vbaud_ baudC =
     {
     VBAUDLO,                           /* Virtual register for lo uint8      */
     VBAUDHI,                           /* Virtual register for hi uint8      */
...
{NUL,BEL,BS,HT,LF,CR,FF,DC3,DC1,DOS_EOF},/* 11 permitted controls            */
     ...
     OFF,                             /* 13 uint8 translation/removal mode    */
...
/*
OBJECT NAME:  struct soctl_ octlC
       TYPE:  struct soctl_
      LEVEL:  0
 DEFINED IN:  SIODEF.H
DECLARED IN:  IBMPC.C
...
{NUL,BEL,BS,HT,LF,CR,FF,DC3,DC1,DOS_EOF},/*11 permitted controls             */
     ...
     OFF,                             /*16 No interuint8_t delay flag           */
...
REG v_regC[V_REG_SIZE][2]=
    {
/*  VIR   USR  */
     { 0,    0 },                         /* 0 = baud low uint8               */
     { 0,    0 },                         /* 1 = baud high uint8              */
...
*/
struct vregbits_ stopsC =          /* for 16x50 UART */
       {
...
struct vregbits_ dlenC =           /* for 16x50 UART */
     {
...
SIO COM3sio  =
     ...
     v_regC,                       /*13 Pointer to virtual register array    */
     V_REG_SIZE,                   /*14 Number of rows in virtual array      */
     &parityC,                     /*15 Parity structure                     */
     &stopsC,                      /*16 Stop bit structure                   */
     &dlenC,                       /*17 Data length structure                */
     &baudC,                       /*18 Baud rate structure                  */
     &pin4C,                       /*19 RS-232 RTS output                    */
     &pin20C,                      /*20 RS-232 DTR output                    */
     &gp1outC,                     /*21 RS-232 first user-defined output     */
     &gp2outC,                     /*22 RS-232 first user-defined output     */
     &breakbC,                     /*23 Break bit                            */
     &pin5C,                       /*24 RS-232 CTS input                     */
     &pin6C,                       /*25 RS-232 DSR input                     */
     &pin8C,                       /*26 RS-232 DCD input                     */
     &pin22C,                      /*27 RS-232 RI  input                     */
     ...
     &octlC,                       /*47 Pointer to output control structure  */
     &ictlC,                       /*48 Pointer input control structure      */
...
//     {TRUE,TRUE,FALSE,FALSE,0,0,0,0},/*49 Interrupts wanted/on bitfield        */
     ...
     NIL,                          /*61 Where in buff to put next uint8       */
     NIL,                          /*62 Where in buff to fetch next uint8     */
     ...
     &baselineC,                   /*72 Modem control strucutre              */
     };
