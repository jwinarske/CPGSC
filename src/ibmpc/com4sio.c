...
/*
OBJECT NAME:  struct soctl_ octlD
       TYPE:  struct soctl_
      LEVEL:  0
 DEFINED IN:  SIODEF.H
DECLARED IN:  IBMPC.C
...
*/
struct vregbits_ stopsD =          /* for 16x50 UART */
       {
...
struct vregbits_ dlenD =           /* for 16x50 UART */
     {
...
SIO COM4sio  =
     ...
     v_regD,                       /*13 Pointer to virtual register array    */
     V_REG_SIZE,                   /*14 Number of rows in virtual array      */
     &parityD,                     /*15 Parity structure                     */
     &stopsD,                      /*16 Stop bit structure                   */
     &dlenD,                       /*17 Data length structure                */
     &baudD,                       /*18 Baud rate structure                  */
     &pin4D,                       /*19 RS-232 RTS output                    */
     &pin20D,                      /*20 RS-232 DTR output                    */
     &gp1outD,                     /*21 RS-232 first user-defined output     */
     &gp2outD,                     /*22 RS-232 first user-defined output     */
     &breakbD,                     /*23 Break bit                            */
     &pin5D,                       /*24 RS-232 CTS input                     */
     &pin6D,                       /*25 RS-232 DSR input                     */
     &pin8D,                       /*26 RS-232 DCD input                     */
     &pin22D,                      /*27 RS-232 RI  input                     */
     ...
     &octlD,                       /*47 Pointer to output control structure  */
     &ictlD,                       /*48 Pointer input control structure      */
...
//     {TRUE,TRUE,FALSE,FALSE,0,0,0,0},/*49 Interrupts wanted/on bitfield        */
     ...
     &baselineD,                   /*72 Modem control strucutre              */
     };
