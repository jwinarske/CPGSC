...
{
     FAST tmpfmt;
     tmpfmt = (*siop->readuint8_t)(siop->uart_base + siop->par->offset) | 0x80;
     (*siop->writeuint8_t)(siop->uart_base + siop->par->offset, tmpfmt);
     (*siop->writeuint8_t)(siop->uart_base + brp->offsetlo, (FAST)lobaud);
     (*siop->writeuint8_t)(siop->uart_base + brp->offsethi, (FAST)hibaud);
     (*siop->writeuint8_t)(siop->uart_base + siop->par->offset, (FAST)(tmpfmt & 0x7f));
